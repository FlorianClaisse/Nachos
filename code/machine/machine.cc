...
Machine::Machine(bool debug)
{
    ...
    this->semRunningProcess = new Semaphore("semRunningProcess", 1);
    #endif
...
Machine::~Machine()
{
    ...
    mainMemory = NULL;
#ifdef CHANGED
    delete this->semRunningProcess;
    this->semRunningProcess = NULL;
#endif
    if (tlb != NULL)
    {
        delete [] tlb;
...
void Machine::UpdateRunningProcess(int value) {
    ...
    DEBUG('x', "runningProcess = %d\n", this->runningProcess);
    this->semRunningProcess->V();
}

bool Machine::ProcessAlone() {
    bool result = false;
    this->semRunningProcess->P();
